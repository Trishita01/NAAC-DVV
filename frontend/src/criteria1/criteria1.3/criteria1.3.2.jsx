...
<li>Minutes of the Boards of Studies/ Academic Council meetings 
with approvals for these courses </li>
<li>Average percentage of courses that include experiential learning 
through project work/field work/internship  (Data  Template)</li> 
          ...
          <div className="border rounded mb-8">
            <div className="flex justify-between items-center bg-blue-100 text-gray-800 px-4 py-2">
              <h2 className="text-xl font-bold"> Courses that include Experiential Learning through project work/field work/internship</h2>
            ...
            <table className="w-full border text-sm border-black">
              <thead className="bg-gray-100 text-gray-950">
                <tr>
                  ...
                  <th className="border px-2 py-2">Name of the Course that include experiential learning 
through project work/field work/internship </th>
                  <th className="border px-2 py-2">Course code</th>
                  <th className="border px-2 py-2">Year of 
offering</th>
                  <th className="border px-2 py-2">Name of the student studied course on experiential 
learning through project work/field work/internship</th>
                ...
                <table className="w-full text-sm border">
                  <thead className="bg-gray-200">
                    <tr>
                      ...
                      <th className="border text-gray-950 px-4 py-2">Name of the Course that include experiential learning 
through project work/field work/internship </th>
                      <th className="border text-gray-950 px-4 py-2">Course code 
 </th>
                      <th className="border text-gray-950 px-4 py-2">Year of 
offering </th>
                      <th className="border text-gray-950 px-4 py-2">Name of the student studied course on experiential 
learning through project work/field work/internship</th>
