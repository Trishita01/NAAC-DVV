...
import Criteria1_4_1 from "../criteria1.4/criteria1.4.1";
const Criteria1_3_3 = () => {
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col p-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <div className="mb-6">
              <h3 className="text-blue-600 font-medium mb-2">1.3.3 Metric Information</h3>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc pl-5 text-sm text-gray-700">
                <li className="mb-1">List of programmes and number of students undertaking project 
work/field work/ /internships </li>
              </ul>
            </div>
          </div>

          <h2 className="text-xl font-bold text-gray-500 mb-4">Students undertaking project work/field work/internship</h2>
